...
exports.LikedSongsService = void 0;
const common_1 = require("@nestjs/common");
const typeorm_1 = require("@nestjs/typeorm");
const typeorm_2 = require("typeorm");
const liked_song_entity_1 = require("./liked-song.entity");
let LikedSongsService = class LikedSongsService {
    constructor(likedSongsRepository) {
        this.likedSongsRepository = likedSongsRepository;
    }
    async likeSong(userId, trackData) {
...
exports.LikedSongsService = LikedSongsService;
exports.LikedSongsService = LikedSongsService = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, typeorm_1.InjectRepository)(liked_song_entity_1.LikedSong)),
    __metadata("design:paramtypes", [typeorm_2.Repository])
], LikedSongsService);
//# sourceMappingURL=liked-songs.service.js.map