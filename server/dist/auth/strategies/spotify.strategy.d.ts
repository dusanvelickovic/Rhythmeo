...
declare const SpotifyStrategy_base: new (...args: [options: import("passport-spotify").StrategyOptions] | [options: import("passport-spotify").StrategyOptionsWithRequest]) => Strategy & {
