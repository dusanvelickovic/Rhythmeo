...
let AuthController = class AuthController {
    constructor(authService, configService) {
        ...
        this.frontendUrl = this.configService.get("FRONTEND_BASE_URL");
    }
    spotifyLogin() {
        return;
    }
    ...
    async getSpotifyToken(req) {
        const accessToken = await this.authService.getAccessToken(req.user.spotifyId);
        if (!accessToken) {
...
__decorate([
    ...
    (0, common_1.UseGuards)(spotify_auth_guard_1.SpotifyAuthGuard),
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], AuthController.prototype, "getSpotifyToken", null);
__decorate([
